# maczo Originals — Slots · Provably Fair

Welcome. This wiki explains how every **Slots** result on [maczo.co](https://maczo.co) is provably
...
- 🔐 **[The Algorithm](Algorithm)** — the HMAC-SHA256 → uint32 engine + Slots's resolve step
...
- **Live (offline in your browser):** https://verify.maczo.co/originals/?game=slots
- **Source / Node CLI:** https://github.com/maczo-co/originals-slots
- **Published odds:** https://verify.maczo.co/originals/paytables/slots.json
